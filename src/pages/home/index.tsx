  ...
  return (
    <Container maxWidth="lg" sx={{ py: { xs: 4, md: 8 } }}>
      <Box display="flex" flexDirection="column" alignItems="center" gap={6}>
        ...
        {/* Navigation Buttons */}
        <Box display="flex" justifyContent="center" gap={4} sx={{ mt: 4 }}>
          <IconButton
            sx={{
              width: 40,
              height: 40,
              ...
              "&::before": {
                ...
                borderImage:
                  "conic-gradient(rgba(255,255,255,0) 16.67%, rgba(255,255,255,0) 83.85%, rgba(255,255,255,0.5) 100%) 1",
              },
            }}
          >
            <Box
              ...
              <Button
                ...
                sx={{
                  ...
                  "&:hover": {
                    ...
                    background:
                      "radial-gradient(50% 50% at 50% 50%, rgba(255,255,255,0.12) 0%, rgba(255,255,255,0.02) 100%)",
                  },
                }}
              >
                Learn more
        ...
        <Grid item xs={12} md={6}>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 4 }}>
            ...
            >
              ...
              of some of the best up and coming international MMA fighters on
              both the professional and amateur circuit!
            </Typography>
  ...
  const accomplishments = [
    {
      ...
      title: "Ape shop",
      description:
        "Creation of our very own native marketplace where both Tribe and 0xApes can be bought, sold, and traded on a secure and user-friendly platform with 0% fees",
    },
    {
      id: 2,
      title: "Tribe Odyssey",
      description:
        "Successful launch of the highly anticipated and entirely original follow up collection to 0xApes",
    },
    {
      id: 3,
      title: "ENS Domains",
      description:
        "Tribe Odyssey has become part of the ENS takeover! Users who hold a Tribe Odyssey NFT, can now register a unique tribeodyssey.eth subdomain",
    },
    {
      id: 4,
      title: "Wallpapers",
      description:
        "Introduction of the Wallpaper application where users are able to update and customize their personal phone and desktop wallpaper displays with their favorite Tribe apes!",
    },
    {
      id: 5,
      title: "IRL Events",
      description:
        "We've held IRL event in Nashville where Tribe holders and family were able to network and socialise. We see this as an important element to reward holders and spread project awerness",
    },
    {
      id: 6,
      title: "Tribe Alliance",
      description:
        "Successful creation and onboarding of celebrities through Tribe Odyssey celebrity network initiative",
    },
    {
      id: 7,
      title: "0xApes",
      description:
        "Successful launch of a first of its kind and extremely popular BAYC expansion project in the NFT space",
    },
    {
      id: 8,
      title: "19: The Exodus",
      description:
        "Limited edition airdrop completed for select OG community members featuring exclusive comic book cover artwork",
    },
  ];
      ...
      try {
        ...
        setStats({
          ...
          floorPrice: data.total.floor_price
            ? data.total.floor_price.toFixed(2)
            : "0",
              ...
              >
                <Typography
                  ...
                  sx={{
                    ...
                    color: "#ff0008",
                    background:
                      "linear-gradient(180deg, #ff0008 0%, #cc0006 100%)",
      ...
      <Box
        sx={{
          ...
          "&::before": {
            ...
            bottom: 0,
            background:
              "linear-gradient(180deg, rgba(20,18,27,0.8) 0%, rgba(0,0,0,0.9) 100%)",
          },
        }}
      >
        <Container
