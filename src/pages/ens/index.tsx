  ...
  return (
    <StyledContainer maxWidth={false}>
      ...
      >
        ...
        >
          <GradientTitle variant="h1">ENS</GradientTitle>
          ...
          <Box sx={{ maxWidth: "800px" }}>
            ...
            >
              Tribe Odyssey has become part of the ENS takeover! Users who hold
              a Tribe Odyssey NFT, can now register a unique tribeodyssey.eth{" "}
            ...
            >
              We look forward to seeing our loyal community repping their new
              and unique Tribe Odyssey subdomains and embracing the ENS
              revolution!
            </Typography>
